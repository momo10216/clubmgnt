...
class nokCMPerson extends nokTable {
	...
	function nokCMPerson($component) {
		...
		$this->addColumnDisplay("list", "address", JText::_( 'TABLE_NOKCM_PERSONS_ADDRESS'));
		$this->addColumnDisplay("list", "zip", JText::_( 'TABLE_NOKCM_PERSONS_ZIP'));
		...
		$this->addColumnDisplay("show", "salutation", JText::_( 'TABLE_NOKCM_PERSONS_SALUTATION'));
		$this->addColumnDisplay("show", "name", JText::_( 'TABLE_NOKCM_PERSONS_NAME'));
		$this->addColumnDisplay("show", "birthname", JText::_( 'TABLE_NOKCM_PERSONS_BIRTHNAME'));
		$this->addColumnDisplay("show", "firstname", JText::_( 'TABLE_NOKCM_PERSONS_FIRSTNAME'));
		$this->addColumnDisplay("show", "middlename", JText::_( 'TABLE_NOKCM_PERSONS_MIDDLENAME'));
		$this->addColumnDisplay("show", "nickname", JText::_( 'TABLE_NOKCM_PERSONS_NICKNAME'));
		$this->addColumnDisplay("show", "address", JText::_( 'TABLE_NOKCM_PERSONS_ADDRESS'));
		$this->addColumnDisplay("show", "zip", JText::_( 'TABLE_NOKCM_PERSONS_ZIP'));
		$this->addColumnDisplay("show", "city", JText::_( 'TABLE_NOKCM_PERSONS_CITY'));
		$this->addColumnDisplay("show", "state", JText::_( 'TABLE_NOKCM_PERSONS_STATE'));
		$this->addColumnDisplay("show", "country", JText::_( 'TABLE_NOKCM_PERSONS_COUNTRY'));
		$this->addColumnDisplay("show", "hh_person_id", JText::_( 'TABLE_NOKCM_PERSONS_HH_PERSON_ID'));
		$this->addColumnDisplay("show", "hh_salutation_override", JText::_( 'TABLE_NOKCM_PERSONS_HH_SALUTATION_OVERRIDE'));
		$this->addColumnDisplay("show", "hh_name_override", JText::_( 'TABLE_NOKCM_PERSONS_HH_NAME_OVERRIDE'));
		$this->addColumnDisplay("show", "birthday", JText::_( 'TABLE_NOKCM_PERSONS_BIRTHDAY'));
		$this->addColumnDisplay("show", "deceased", JText::_( 'TABLE_NOKCM_PERSONS_DECEASED'));
		$this->addColumnDisplay("show", "telephone", JText::_( 'TABLE_NOKCM_PERSONS_TELEPHONE'));
		$this->addColumnDisplay("show", "mobile", JText::_( 'TABLE_NOKCM_PERSONS_MOBILE'));
		$this->addColumnDisplay("show", "email", JText::_( 'TABLE_NOKCM_PERSONS_EMAIL'));
		$this->addColumnDisplay("show", "url", JText::_( 'TABLE_NOKCM_PERSONS_URL'));
		$this->addColumnDisplay("show", "user_id", JText::_( 'TABLE_NOKCM_PERSONS_USER_ID'));
		if ((strtolower($picdir) != "none") && ($picdir != "")) {
			$this->addColumnDisplay("show", "image", JText::_( 'TABLE_NOKCM_PERSONS_IMAGE'));
		}
		if ($component != "") {
		...
		$this->addColumnDisplay("show", "description", JText::_( 'TABLE_NOKCM_PERSONS_DESCRIPTION'));
		$this->addColumnDisplay("show", "createdby", JText::_( 'TABLE_NOKCM_PERSONS_CREATEDBY'));
		$this->addColumnDisplay("show", "createddate", JText::_( 'TABLE_NOKCM_PERSONS_CREATEDDATE'));
		$this->addColumnDisplay("show", "modifiedby", JText::_( 'TABLE_NOKCM_PERSONS_MODIFIEDBY'));
		$this->addColumnDisplay("show", "modifieddate", JText::_( 'TABLE_NOKCM_PERSONS_MODIFIEDDATE'));

		// Define fields and lables for data entry
		$this->addColumnDisplay("edit", "salutation", JText::_( 'TABLE_NOKCM_PERSONS_SALUTATION'));
		$this->addColumnDisplay("edit", "name", JText::_( 'TABLE_NOKCM_PERSONS_NAME'));
		$this->addColumnDisplay("edit", "birthname", JText::_( 'TABLE_NOKCM_PERSONS_BIRTHNAME'));
		$this->addColumnDisplay("edit", "firstname", JText::_( 'TABLE_NOKCM_PERSONS_FIRSTNAME'));
		$this->addColumnDisplay("edit", "middlename", JText::_( 'TABLE_NOKCM_PERSONS_MIDDLENAME'));
		$this->addColumnDisplay("edit", "nickname", JText::_( 'TABLE_NOKCM_PERSONS_NICKNAME'));
		$this->addColumnDisplay("edit", "address", JText::_( 'TABLE_NOKCM_PERSONS_ADDRESS'));
		$this->addColumnDisplay("edit", "zip", JText::_( 'TABLE_NOKCM_PERSONS_ZIP'));
		$this->addColumnDisplay("edit", "city", JText::_( 'TABLE_NOKCM_PERSONS_CITY'));
		$this->addColumnDisplay("edit", "state", JText::_( 'TABLE_NOKCM_PERSONS_STATE'));
		$this->addColumnDisplay("edit", "country", JText::_( 'TABLE_NOKCM_PERSONS_COUNTRY'));
		$this->addColumnDisplay("edit", "hh_person_id", JText::_( 'TABLE_NOKCM_PERSONS_HH_PERSON_ID'));
		$this->addColumnDisplay("edit", "hh_salutation_override", JText::_( 'TABLE_NOKCM_PERSONS_HH_SALUTATION_OVERRIDE'));
		$this->addColumnDisplay("edit", "hh_name_override", JText::_( 'TABLE_NOKCM_PERSONS_HH_NAME_OVERRIDE'));
		$this->addColumnDisplay("edit", "birthday", JText::_( 'TABLE_NOKCM_PERSONS_BIRTHDAY'));
		$this->addColumnDisplay("edit", "deceased", JText::_( 'TABLE_NOKCM_PERSONS_DECEASED'));
		$this->addColumnDisplay("edit", "telephone", JText::_( 'TABLE_NOKCM_PERSONS_TELEPHONE'));
		$this->addColumnDisplay("edit", "mobile", JText::_( 'TABLE_NOKCM_PERSONS_MOBILE'));
		$this->addColumnDisplay("edit", "email", JText::_( 'TABLE_NOKCM_PERSONS_EMAIL'));
		$this->addColumnDisplay("edit", "url", JText::_( 'TABLE_NOKCM_PERSONS_URL'));
		$this->addColumnDisplay("edit", "user_id", JText::_( 'TABLE_NOKCM_PERSONS_USER_ID'));
		if ((strtolower($picdir) != "none") && ($picdir != "")) {
			$this->addColumnDisplay("edit", "image", JText::_( 'TABLE_NOKCM_PERSONS_IMAGE'));
		}
		if ($component != "") {
		...
		$this->addColumnDisplay("edit", "description", JText::_( 'TABLE_NOKCM_PERSONS_DESCRIPTION'));
		$this->addColumnDisplay("edit", "createdby", JText::_( 'TABLE_NOKCM_PERSONS_CREATEDBY'));
		$this->addColumnDisplay("edit", "createddate", JText::_( 'TABLE_NOKCM_PERSONS_CREATEDDATE'));
		$this->addColumnDisplay("edit", "modifiedby", JText::_( 'TABLE_NOKCM_PERSONS_MODIFIEDBY'));
		$this->addColumnDisplay("edit", "modifieddate", JText::_( 'TABLE_NOKCM_PERSONS_MODIFIEDDATE'));
		...
		$this->addColumnDisplay("view", "abirthday", JText::_( 'TABLE_NOKCM_PERSONS_ABIRTHDAY'));
		$this->addColumnDisplay("view", "deceased", JText::_( 'TABLE_NOKCM_PERSONS_DECEASED'));
		...
		$this->addColumnDisplay("view", "user_id", JText::_( 'TABLE_NOKCM_PERSONS_USER_ID'));
		if ((strtolower($picdir) != "none") && ($picdir != "")) {
		...
		$this->addColumnDisplay("view", "description", JText::_( 'TABLE_NOKCM_PERSONS_DESCRIPTION'));
		$this->addColumnDisplay("view", "createdby", JText::_( 'TABLE_NOKCM_PERSONS_CREATEDBY'));
		$this->addColumnDisplay("view", "createddate", JText::_( 'TABLE_NOKCM_PERSONS_CREATEDDATE'));
		$this->addColumnDisplay("view", "modifiedby", JText::_( 'TABLE_NOKCM_PERSONS_MODIFIEDBY'));
		$this->addColumnDisplay("view", "modifieddate", JText::_( 'TABLE_NOKCM_PERSONS_MODIFIEDDATE'));
