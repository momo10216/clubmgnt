...
class nokCMMembership extends nokTable {
	...
	function nokCMMembership($component) {
		...
		$this->addColumnDisplay("list", "published", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_PUBLISHED'));
		$this->addColumnDisplay("list", "type", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_TYPE'));
		$this->addColumnDisplay("list", "begin", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_BEGIN'));
		$this->addColumnDisplay("list", "end", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_END'));
		...
		$this->addColumnDisplay("show", "person_id", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_PERSON_ID'));
		$this->addColumnDisplay("show", "published", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_PUBLISHED'));
		$this->addColumnDisplay("show", "type", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_TYPE'));
		$this->addColumnDisplay("show", "begin", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_BEGIN'));
		$this->addColumnDisplay("show", "end", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_END'));
		$this->addColumnDisplay("show", "createdby", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_CREATEDBY'));
		$this->addColumnDisplay("show", "createddate", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_CREATEDDATE'));
		$this->addColumnDisplay("show", "modifiedby", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_MODIFIEDBY'));
		$this->addColumnDisplay("show", "modifieddate", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_MODIFIEDDATE'));

		// Define fields and lables for data entry
		$this->addColumnDisplay("edit", "person_id", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_PERSON_ID'));
		$this->addColumnDisplay("edit", "published", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_PUBLISHED'));
		$this->addColumnDisplay("edit", "type", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_TYPE'));
		$this->addColumnDisplay("edit", "begin", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_BEGIN'));
		$this->addColumnDisplay("edit", "end", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_END'));
		$this->addColumnDisplay("edit", "createdby", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_CREATEDBY'));
		$this->addColumnDisplay("edit", "createddate", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_CREATEDDATE'));
		$this->addColumnDisplay("edit", "modifiedby", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_MODIFIEDBY'));
		$this->addColumnDisplay("edit", "modifieddate", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_MODIFIEDDATE'));

		// Define fields and columnname for view
		$this->addColumnDisplay("view", "id", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_ID'));
		...
		$this->addColumnDisplay("view", "type", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_TYPE'));
		$this->addColumnDisplay("view", "begin", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_BEGIN'));
		$this->addColumnDisplay("view", "end", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_END'));
		$this->addColumnDisplay("view", "beginyear", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_BEGINYEAR'));
		$this->addColumnDisplay("view", "endyear", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_ENDYEAR'));
		$this->addColumnDisplay("view", "beginendyear", JText::_( 'TABLE_NOKCM_MEMBERSHIPS_BEGINENDYEAR'));
		if (strtolower($picdir) != "none") {
