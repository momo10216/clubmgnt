...
class JFormFieldCmBoardColumn extends JFormField {
    ...
    public function getInput() {
		...
		$fields = array(
			...
			"board_id" => self::translate('COM_CLUBMANAGEMENT_BOARDENTRIES_FIELD_ID_LABEL'),
			"person_id" => self::translate('COM_CLUBMANAGEMENT_BOARDENTRIES_FIELD_PERSON_ID_LABEL'),
			"person_fullname" => self::translate('COM_CLUBMANAGEMENT_PERSONS_FIELD_FULLNAME_LABEL'),
			...
			"board_job" => self::translate('COM_CLUBMANAGEMENT_BOARDENTRIES_FIELD_JOB_LABEL'),
			"board_begin" => self::translate('COM_CLUBMANAGEMENT_BOARDENTRIES_FIELD_BEGIN_LABEL'),
			"board_end" => self::translate('COM_CLUBMANAGEMENT_BOARDENTRIES_FIELD_END_LABEL'),
			"board_beginyear" => self::translate('COM_CLUBMANAGEMENT_BOARDENTRIES_FIELD_BEGINYEAR_LABEL'),
			"board_endyear" => self::translate('COM_CLUBMANAGEMENT_BOARDENTRIES_FIELD_ENDYEAR_LABEL'),
			"board_beginendyear" => self::translate('COM_CLUBMANAGEMENT_BOARDENTRIES_FIELD_BEGINENDYEAR_LABEL'),
			"board_published" => self::translate('COM_CLUBMANAGEMENT_BOARDENTRIES_FIELD_PUBLISHED_LABEL'),
			"board_sortorder" => self::translate('COM_CLUBMANAGEMENT_BOARDENTRIES_FIELD_SORTORDER_LABEL'),
			"board_createdby" => self::translate('COM_CLUBMANAGEMENT_BOARDENTRIES_FIELD_CREATEDBY_LABEL'),
			"board_createddate" => self::translate('COM_CLUBMANAGEMENT_BOARDENTRIES_FIELD_CREATEDDATE_LABEL'),
			"board_modifiedby" => self::translate('COM_CLUBMANAGEMENT_BOARDENTRIES_FIELD_MODIFIEDBY_LABEL'),
			"board_modifieddate" => self::translate('COM_CLUBMANAGEMENT_BOARDENTRIES_FIELD_MODIFIEDDATE_LABEL'),
