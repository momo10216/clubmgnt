...
class JFormFieldCmMembershipColumn extends JFormField {
    ...
    public function getInput() {
		...
		$fields = array(
			...
			"member_id" => Text::_('COM_CLUBMANAGEMENT_MEMBERSHIPS_FIELD_ID_LABEL'),
			"person_id" => Text::_('COM_CLUBMANAGEMENT_MEMBERSHIPS_FIELD_PERSON_ID_LABEL'),
			...
			"member_type" => Text::_('COM_CLUBMANAGEMENT_MEMBERSHIPS_FIELD_TYPE_LABEL'),
			"member_begin" => Text::_('COM_CLUBMANAGEMENT_MEMBERSHIPS_FIELD_BEGIN_LABEL'),
			"member_end" => Text::_('COM_CLUBMANAGEMENT_MEMBERSHIPS_FIELD_END_LABEL'),
			"member_beginyear" => Text::_('COM_CLUBMANAGEMENT_MEMBERSHIPS_FIELD_BEGINYEAR_LABEL'),
			"member_endyear" => Text::_('COM_CLUBMANAGEMENT_MEMBERSHIPS_FIELD_ENDYEAR_LABEL'),
			"member_beginendyear" => Text::_('COM_CLUBMANAGEMENT_MEMBERSHIPS_FIELD_BEGINENDYEAR_LABEL'),
			"member_published" => Text::_('COM_CLUBMANAGEMENT_MEMBERSHIPS_FIELD_PUBLISHED_LABEL'),
			"member_createdby" => Text::_('COM_CLUBMANAGEMENT_MEMBERSHIPS_FIELD_CREATEDBY_LABEL'),
			"member_createddate" => Text::_('COM_CLUBMANAGEMENT_MEMBERSHIPS_FIELD_CREATEDDATE_LABEL'),
			"member_modifiedby" => Text::_('COM_CLUBMANAGEMENT_MEMBERSHIPS_FIELD_MODIFIEDBY_LABEL'),
			"member_modifieddate" => Text::_('COM_CLUBMANAGEMENT_MEMBERSHIPS_FIELD_MODIFIEDDATE_LABEL'),
