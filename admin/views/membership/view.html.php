...
class ClubManagementViewMembership extends JViewLegacy {
	...
	protected function addToolbar() {
		...
		$canDo		= $this->canDo;
		JToolbarHelper::title(($isNew ? self::translate('COM_CLUBMANAGEMENT_MEMBERSHIPS_PAGE_ADD') : self::translate('COM_CLUBMANAGEMENT_MEMBERSHIPS_PAGE_EDIT')), 'pencil-2 article-add');
